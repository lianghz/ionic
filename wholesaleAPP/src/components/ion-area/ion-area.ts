  ...
  ngOnInit() {
    ...
    this.service.addrPostParamsEvent.subscribe(
      ...
      data => {
        ...
        this.addrParentIds[0] = -1;
        this.addrParentIds[1] = this.addrPostParams.regionId1;
        this.addrParentIds[2] = this.addrPostParams.regionId2;
        this.addrParentIds[3] = this.addrPostParams.regionId3;
